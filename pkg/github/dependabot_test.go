...
func Test_GetDependabotAlert(t *testing.T) {
	...
	// Cast InputSchema to *jsonschema.Schema to access properties
	schema, ok := tool.InputSchema.(*jsonschema.Schema)
	require.True(t, ok, "expected InputSchema to be of type *jsonschema.Schema")
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			// Call handler with args directly
